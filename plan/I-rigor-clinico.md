...
| RC | Tema | Nota | Estado |
|---|---|---|---|
| RC-28 | **Bebé** (gases, plagiocefalia, boca abajo, hitos, orientación óptica) | **DESBLOQUEADO (25/09/2026):** tiene formación Vojta (320 h, International Vojta Society) y paso por neuroterapia pediátrica (¿estudiante o profesional? por confirmar, ver `02-cv-comparacion.md`). **Límites:** el Método Vojta se aplica **por prescripción médica**, así que no se enseña como técnica para hacer en casa. Contenido dirigido a cuidadores; sin manipulaciones ni rutinas universales; ante dudas del desarrollo, al pediatra. Fuentes a revisar: AAP (tiempo boca abajo supervisado), guías de plagiocefalia posicional | Activo con límites |
